...
create database if not exists metro_bd;
use metro_bd;
create table lines_2 (id int auto_increment primary key, line_name varchar(20) not null, 
stations_count int not null, length_km decimal(4,1) not null, daily_passengers int not null);

INSERT INTO lines_2 (line_name, stations_count, length_km, daily_passengers) VALUES
('A1', 12, 15.5, 120000),
('B2', 9, 11.2, 85000),
('C3', 14, 18.0, 150000),
('D4', 7, 9.3, 60000),
